...
namespace
{
    const char* const WINDOW_TITLE = "Kenneth Posley"; // Macro for window title
...
void UCreateMesh(GLMesh& mesh)
{
    ...
    GLfloat verts[] = {
      ...
      -0.5f, -0.5f, -0.5f,  1.0f,  0.0f,  0.0f,   //Pink side of watch
     ...
     -0.5f, -0.5f,  0.5f, -1.0f,  0.0f,  0.0f,    //Green side of watch face
      0.5f, -0.5f,  0.5f, -1.0f,  0.0f,  0.0f,
      0.5f,  0.5f,  0.5f, -1.0f,  0.0f,  0.0f,
      0.5f,  0.5f,  0.5f, -1.0f,  0.0f,  0.0f,
     -0.5f,  0.5f,  0.5f, -1.0f,  0.0f,  0.0f,
     ...
     -0.5f,  0.5f,  0.5f,  1.0f,  0.0f,  0.0f,    //Blue side of wacth face
     -0.5f,  0.5f, -0.5f,  1.0f,  0.0f,  0.0f,
     -0.5f, -0.5f, -0.5f,  1.0f,  0.0f,  0.0f,
     -0.5f, -0.5f, -0.5f,  1.0f,  0.0f,  0.0f,
     -0.5f, -0.5f,  0.5f,  1.0f,  0.0f,  0.0f,
     ...
     0.5f,  0.5f,  0.5f,  0.0f, -1.0f,  0.0f,     //Yellow side of watch face
     ...
     -0.5f, -0.5f, -0.5f,  0.0f,  0.0f,  1.0f,     //Bottom blue side of watch face
    ...
    -0.5f,  0.5f, -0.5f,  0.0f,  0.0f, -1.0f,  //Top Pink side of wach face
     0.5f,  0.5f, -0.5f,  0.0f,  0.0f, -1.0f,
     0.5f,  0.5f,  0.5f,  0.0f,  0.0f, -1.0f,
     0.5f,  0.5f,  0.5f,  0.0f,  0.0f, -1.0f,
    -0.5f,  0.5f,  0.5f,  0.0f,  0.0f, -1.0f,
   ...
   -2.5f,  -0.5f, -0.5f,  0.0f,  0.0f,  1.0f,   //bottom pink watchband
  ...
  -2.5f,   0.0f, -0.5f,  1.0f,  0.0f,  0.0f,   //top pink watchband
   2.5f,  -0.0f, -0.5f,  1.0f,  0.0f,  0.0f,
   2.5f,  -0.0f,  0.5f,  1.0f,  0.0f,  0.0f,
   2.5f,  -0.0f,  0.5f,  1.0f,  0.0f,  0.0f,
  -2.5f,  -0.0f,  0.5f,  1.0f,  0.0f,  0.0f,
  -2.5f,  -0.0f, -0.5f,  1.0f,  0.0f,  0.0f,
  ...
  //Right Face         //Positive X Normals
  -2.5f, -0.5f,  0.5f,  1.0f,  0.0f,  0.0f,    //bottom green side of watchband
   0.5f, -0.5f,  0.5f,  1.0f,  0.0f,  0.0f,
  ...
  //Bottom Face        //Negative Y Normals
  2.5f, -0.5f,  0.5f,  0.0f, -1.0f,  0.0f,     //top green side of watchband
  0.5f, -0.5f,  0.5f,  0.0f, -1.0f,  0.0f,
  0.5f,  0.0f,  0.5f,  0.0f, -1.0f,  0.0f,
  0.5f,  0.0f,  0.5f,  0.0f, -1.0f,  0.0f,
  2.5f,  0.0f,  0.5f,  0.0f, -1.0f,  0.0f,
  2.5f, -0.5f,  0.5f,  0.0f, -1.0f,  0.0f,

  //Top Face           //Positive Y Normals
  -2.5f,  0.0f,  0.5f,  0.0f,  1.0f,  0.0f,     //bottom blue side of watchband
  -2.5f,  0.0f, -0.5f,  0.0f,  1.0f,  0.0f,
  -2.5f, -0.5f, -0.5f,  0.0f,  1.0f,  0.0f,
  -2.5f, -0.5f, -0.5f,  0.0f,  1.0f,  0.0f,
  -2.5f, -0.5f,  0.5f,  0.0f,  1.0f,  0.0f,
  ...
  //Bottom Face        //Negative Y Normals
  2.5f,  0.0f,  0.5f, 0.0f, -1.0f,  0.0f,     //top blue side of watchband
  2.5f,  0.0f, -0.5f, 0.0f, -1.0f,  0.0f,
  2.5f, -0.5f, -0.5f, 0.0f, -1.0f,  0.0f,
  2.5f, -0.5f, -0.5f, 0.0f, -1.0f,  0.0f,
  2.5f, -0.5f,  0.5f, 0.0f, -1.0f,  0.0f,
  ...
  //Top Face           //Positive Y Normals
  -2.5f, -0.5f, -0.5f, 0.0f,  1.0f,  0.0f,     //Red back side of watchband
   2.5f, -0.5f, -0.5f, 0.0f,  1.0f,  0.0f,
   2.5f,  0.0f, -0.5f, 0.0f,  1.0f,  0.0f,
   2.5f,  0.0f, -0.5f, 0.0f,  1.0f,  0.0f,
  -2.5f,  0.0f, -0.5f, 0.0f,  1.0f,  0.0f,
